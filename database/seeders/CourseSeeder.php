...
class CourseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('courses')->insert([
            ...
            //BSCS & BSIT
            ['course_code' => "GNED 02", 'course_name' => "Ethics", 'lecture_units' => 3, 'lab_units' => 0, 'lecture_hours' => 3, 'lab_hours' => 0, 'semester' => '1st Semester', 'year_level' => '1st Year', 'program' => null],
            ['course_code' => "GNED 05", 'course_name' => "Purposive Communication", 'lecture_units' => 3, 'lab_units' => 0, 'lecture_hours' => 3, 'lab_hours' => 0, 'semester' => '1st Semester', 'year_level' => '1st Year', 'program' => null],
            ['course_code' => "GNED 11", 'course_name' => "Kontesktwalisadong Komunikasyon sa Filipino", 'lecture_units' => 3, 'lab_units' => 0, 'lecture_hours' => 3, 'lab_hours' => 0, 'semester' => '1st Semester', 'year_level' => '1st Year', 'program' => null],
            ['course_code' => "COSC 50", 'course_name' => "Discrete Structures I", 'lecture_units' => 3, 'lab_units' => 0, 'lecture_hours' => 3, 'lab_hours' => 0, 'semester' => '1st Semester', 'year_level' => '1st Year', 'program' => null],
            ['course_code' => "DCIT 21", 'course_name' => "Introduction to Computing", 'lecture_units' => 2, 'lab_units' => 1, 'lecture_hours' => 2, 'lab_hours' => 6, 'semester' => '1st Semester', 'year_level' => '1st Year', 'program' => null],
            ['course_code' => "DCIT 22", 'course_name' => "Computer Programming I", 'lecture_units' => 1, 'lab_units' => 2, 'lecture_hours' => 1, 'lab_hours' => 3, 'semester' => '1st Semester', 'year_level' => '1st Year', 'program' => null],
            ['course_code' => "FITT 1", 'course_name' => "Movement Enhancement", 'lecture_units' => 2, 'lab_units' => 0, 'lecture_hours' => 3, 'lab_hours' => 0, 'semester' => '1st Semester', 'year_level' => '1st Year', 'program' => null],
            ['course_code' => "NSTP 1", 'course_name' => "National Service Training Program 1", 'lecture_units' => 3, 'lab_units' => 0, 'lecture_hours' => 2, 'lab_hours' => 0, 'semester' => '1st Semester', 'year_level' => '1st Year', 'program' => null],
            ['course_code' => 'CvSU 101', 'course_name' => 'Institutional Orientation', 'lecture_units' => 1, 'lab_units' => 0, 'lecture_hours' => 1, 'lab_hours' => 0, 'semester' => '1st Semester', 'year_level' => '1st Year', 'program' => null],
            //2nd Semester, 1st Year
            //BSCS & BSIT
            ['course_code' => 'GNED 01', 'course_name' => 'Art Appreciation', 'lecture_units' => 3, 'lab_units' => 0, 'lecture_hours' => 3, 'lab_hours' => 0, 'semester' => '2nd Semester', 'year_level' => '1st Year', 'program' => null],
            ['course_code' => 'GNED 03', 'course_name' => 'Mathematics in the Modern World', 'lecture_units' => 3, 'lab_units' => 0, 'lecture_hours' => 3, 'lab_hours' => 0, 'semester' => '2nd Semester', 'year_level' => '1st Year', 'program' => null],
            ['course_code' => 'GNED 06', 'course_name' => 'Science, Technology and Society', 'lecture_units' => 3, 'lab_units' => 0, 'lecture_hours' => 3, 'lab_hours' => 0, 'semester' => '2nd Semester', 'year_level' => '1st Year', 'program' => null],
            ['course_code' => 'ITEC 50', 'course_name' => 'Web Systems and Technologies', 'lecture_units' => 2, 'lab_units' => 1, 'lecture_hours' => 2, 'lab_hours' => 3, 'semester' => '2nd Semester', 'year_level' => '1st Year', 'program' => null],
            ['course_code' => "DCIT 23", 'course_name' => "Computer Programming II", 'lecture_units' => 1, 'lab_units' => 2, 'lecture_hours' => 1, 'lab_hours' => 6, 'semester' => '2nd Semester', 'year_level' => '1st Year', 'program' => null],
            ['course_code' => 'GNED 12', 'course_name' => 'Dalumat Ng/Sa Filipino', 'lecture_units' => 3, 'lab_units' => 0, 'lecture_hours' => 3, 'lab_hours' => 0, 'semester' => '2nd Semester', 'year_level' => '1st Year', 'program' => null],
            ['course_code' => 'FITT 2', 'course_name' => 'Fitness Exercises', 'lecture_units' => 2, 'lab_units' => 0, 'lecture_hours' => 2, 'lab_hours' => 0, 'semester' => '2nd Semester', 'year_level' => '1st Year', 'program' => null],
            ['course_code' => 'NSTP 2', 'course_name' => 'National Service Training Program 2', 'lecture_units' => 3, 'lab_units' => 0, 'lecture_hours' => 3, 'lab_hours' => 0, 'semester' => '2nd Semester', 'year_level' => '1st Year', 'program' => null],


//            // 1st Semester, 2nd Year
            //BSCS & BSIT
            ['course_code' => 'GNED 04', 'course_name' => 'Mga Babasahin Hinggil sa Kasaysayan ng Pilipinas', 'lecture_units' => 3, 'lab_units' => 0, 'lecture_hours' => 3, 'lab_hours' => 0, 'semester' => '1st Semester', 'year_level' => '2nd Year', 'program' => null],
            ['course_code' => 'DCIT 50', 'course_name' => 'Object Oriented Programming', 'lecture_units' => 2, 'lab_units' => 1, 'lecture_hours' => 2, 'lab_hours' => 3, 'semester' => '1st Semester', 'year_level' => '2nd Year', 'program' => null],
            ['course_code' => 'DCIT 24', 'course_name' => 'Information Management', 'lecture_units' => 2, 'lab_units' => 1, 'lecture_hours' => 2, 'lab_hours' => 3, 'semester' => '1st Semester', 'year_level' => '2nd Year', 'program' => null],
            ['course_code' => 'FITT 3', 'course_name' => 'Physical Activities towards Health and Fitness 1', 'lecture_units' => 2, 'lab_units' => 0, 'lecture_hours' => 2, 'lab_hours' => 0, 'semester' => '1st Semester', 'year_level' => '2nd Year', 'program' => null],
            // BSCS
            ['course_code' => 'MATH 01', 'course_name' => 'Analytic Geometry', 'lecture_units' => 3,  'lab_units' => 0, 'lecture_hours' => 3, 'lab_hours' => 0, 'semester' => '1st Semester', 'year_level' => '2nd Year', 'program' => 'BSCS'],
            ['course_code' => 'COSC 55', 'course_name' => 'Discrete Structures', 'lecture_units' => 3, 'lab_units' => 0, 'lecture_hours' => 3, 'lab_hours' => 0, 'semester' => '1st Semester', 'year_level' => '2nd Year', 'program' => 'BSCS'],
            ['course_code' => 'COSC 60', 'course_name' => 'Digital Logic Design', 'lecture_units' => 2, 'lab_units' => 1, 'lecture_hours' => 2, 'lab_hours' => 3, 'semester' => '1st Semester', 'year_level' => '2nd Year', 'program' => 'BSCS'],
            ['course_code' => 'INSY 50', 'course_name' => 'Fundamentals of Information Systems', 'lecture_units' => 3, 'lab_units' => 0, 'lecture_hours' => 3, 'lab_hours' => 0, 'semester' => '1st Semester', 'year_level' => '2nd Year', 'program' => 'BSCS'],
            // BSIT
            ['course_code' => 'ITEC 55', 'course_name' => 'Platform Technologies', 'lecture_units' => 2, 'lab_units' => 1, 'lecture_hours' => 3, 'lab_hours' => 0, 'semester' => '1st Semester', 'year_level' => '2nd Year', 'program' => 'BSCS'],
...
//            SPECIAL COURSES: Courses that are present in both BSCS and BSIT but is taken on different year and/or different semester
            ['course_code' => 'GNED 14', 'course_name' => 'Panitikan Panlipunan', 'lecture_units' => 3, 'lab_units' => 0, 'lecture_hours' => 3, 'lab_hours' => 0, 'semester' => null, 'year_level' => null, 'program' => null],
            ...
            ['course_code' => 'GNED 07', 'course_name' => 'The Contemporary World', 'lecture_units' => 3, 'lab_units' => 0, 'lecture_hours' => 3, 'lab_hours' => 0, 'semester' => null, 'year_level' => null, 'program' => null],
            ['course_code' => 'GNED 10', 'course_name' => 'Gender and Society', 'lecture_units' => 3, 'lab_units' => 0, 'lecture_hours' => 3, 'lab_hours' => 0, 'semester' => null, 'year_level' => null, 'program' => null],
