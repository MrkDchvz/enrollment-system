...
return new class extends Migration
{
    ...
    {
        Schema::create('student_number_generators', function (Blueprint $table) {
            $table->id();
            $table->integer('iteration')->default(1);
            $table->string('school_year')->unique()->default(static::getCurrentSchoolYear());
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('student_number_generators');
    }
